...
const sqlHost = process.env.DB_HOST || process.env.AWS_RDS_HOST || awsStoredConfig.rdsHost || process.env.SQL_HOST || process.env.PGHOST || "localhost";
...
const databaseUrl = process.env.DATABASE_URL || process.env.AWS_RDS_URL;
